...
public class FileLogUnixIntTest {
	...
	public void readFileReal() {
		List<LapDto> laps = this.fileLogUnix.getLapsFromFile("/home/renandpf/Documentos/desenvolvimento/projetos/code/race-time-api/src/test/resources/race.log");
		assertEquals(23, laps.size());
		assertEquals(LocalTime.parse("23:49:08.277"), laps.get(0).getTime());
		assertEquals(38, laps.get(0).getPilotCode(), 0);
		assertEquals("F.MASSA", laps.get(0).getPilotName());
		...
		assertEquals(44.275, laps.get(0).getAverage(), 0);

		assertEquals(LocalTime.parse("23:49:10.858"), laps.get(1).getTime());
		assertEquals(33, laps.get(1).getPilotCode(), 0);
		assertEquals("R.BARRICHELLO", laps.get(1).getPilotName());
		...
		assertEquals(43.243, laps.get(1).getAverage(), 0);

		assertEquals(LocalTime.parse("23:49:11.075"), laps.get(2).getTime());
		assertEquals(2, laps.get(2).getPilotCode(), 0);
		assertEquals("K.RAIKKONEN", laps.get(2).getPilotName());
		...
		assertEquals(43.408, laps.get(2).getAverage(), 0);

		assertEquals(LocalTime.parse("23:49:12.667"), laps.get(3).getTime());
		assertEquals(23, laps.get(3).getPilotCode(), 0);
		assertEquals("M.WEBBER", laps.get(3).getPilotName());
		...
		assertEquals(43.202, laps.get(3).getAverage(), 0);

		assertEquals(LocalTime.parse("23:49:30.976"), laps.get(4).getTime());
		assertEquals(15, laps.get(4).getPilotCode(), 0);
		assertEquals("F.ALONSO", laps.get(4).getPilotName());
		...
		assertEquals(35.47, laps.get(4).getAverage(), 0);

		assertEquals(LocalTime.parse("23:50:11.447"), laps.get(5).getTime());
		assertEquals(38, laps.get(5).getPilotCode(), 0);
		assertEquals("F.MASSA", laps.get(5).getPilotName());
		...
		assertEquals(44.053, laps.get(5).getAverage(), 0);

		assertEquals(LocalTime.parse("23:50:14.860"), laps.get(6).getTime());
		assertEquals(33, laps.get(6).getPilotCode(), 0);
		assertEquals("R.BARRICHELLO", laps.get(6).getPilotName());
		...
		assertEquals(43.48, laps.get(6).getAverage(), 0);

		assertEquals(LocalTime.parse("23:50:15.057"), laps.get(7).getTime());
		assertEquals(2, laps.get(7).getPilotCode(), 0);
		assertEquals("K.RAIKKONEN", laps.get(7).getPilotName());
		...
		assertEquals(43.493, laps.get(7).getAverage(), 0);

		assertEquals(LocalTime.parse("23:50:17.472"), laps.get(8).getTime());
		assertEquals(23, laps.get(8).getPilotCode(), 0);
		assertEquals("M.WEBBER", laps.get(8).getPilotName());
		...
		assertEquals(42.941, laps.get(8).getAverage(), 0);

		assertEquals(LocalTime.parse("23:50:37.987"), laps.get(9).getTime());
		assertEquals(15, laps.get(9).getPilotCode(), 0);
		assertEquals("F.ALONSO", laps.get(9).getPilotName());
		...
		assertEquals(41.528, laps.get(9).getAverage(), 0);

		assertEquals(LocalTime.parse("23:51:14.216"), laps.get(10).getTime());
		assertEquals(38, laps.get(10).getPilotCode(), 0);
		assertEquals("F.MASSA", laps.get(10).getPilotName());
		...
		assertEquals(44.334, laps.get(10).getAverage(), 0);

		assertEquals(LocalTime.parse("23:51:18.576"), laps.get(11).getTime());
		assertEquals(33, laps.get(11).getPilotCode(), 0);
		assertEquals("R.BARRICHELLO", laps.get(11).getPilotName());
		...
		assertEquals(43.675, laps.get(11).getAverage(), 0);

		assertEquals(LocalTime.parse("23:51:19.044"), laps.get(12).getTime());
		assertEquals(2, laps.get(12).getPilotCode(), 0);
		assertEquals("K.RAIKKONEN", laps.get(12).getPilotName());
		...
		assertEquals(43.49, laps.get(12).getAverage(), 0);

		assertEquals(LocalTime.parse("23:51:21.759"), laps.get(13).getTime());
		assertEquals(23, laps.get(13).getPilotCode(), 0);
		assertEquals("M.WEBBER", laps.get(13).getPilotName());
		...
		assertEquals(43.287, laps.get(13).getAverage(), 0);

		assertEquals(LocalTime.parse("23:51:46.691"), laps.get(14).getTime());
		assertEquals(15, laps.get(14).getPilotCode(), 0);
		assertEquals("F.ALONSO", laps.get(14).getPilotName());
		...
		assertEquals(40.504, laps.get(14).getAverage(), 0);

		assertEquals(LocalTime.parse("23:52:01.796"), laps.get(15).getTime());
		assertEquals(11, laps.get(15).getPilotCode(), 0);
		assertEquals("S.VETTEL", laps.get(15).getPilotName());
		...
		assertEquals(13.169, laps.get(15).getAverage(), 0);

		assertEquals(LocalTime.parse("23:52:17.003"), laps.get(16).getTime());
		assertEquals(38, laps.get(16).getPilotCode(), 0);
		assertEquals("F.MASS", laps.get(16).getPilotName());
		...
		assertEquals(44.321, laps.get(16).getAverage(), 0);

		assertEquals(LocalTime.parse("23:52:22.586"), laps.get(17).getTime());
		assertEquals(33, laps.get(17).getPilotCode(), 0);
		assertEquals("R.BARRICHELLO", laps.get(17).getPilotName());
		...
		assertEquals(43.474, laps.get(17).getAverage(), 0);

		assertEquals(LocalTime.parse("23:52:22.120"), laps.get(18).getTime());
		assertEquals(2, laps.get(18).getPilotCode(), 0);
		assertEquals("K.RAIKKONEN", laps.get(18).getPilotName());
		...
		assertEquals(44.118, laps.get(18).getAverage(), 0);

		assertEquals(LocalTime.parse("23:52:25.975"), laps.get(19).getTime());
		assertEquals(23, laps.get(19).getPilotCode(), 0);
		assertEquals("M.WEBBER", laps.get(19).getPilotName());
		...
		assertEquals(43.335, laps.get(19).getAverage(), 0);

		assertEquals(LocalTime.parse("23:53:06.741"), laps.get(20).getTime());
		assertEquals(15, laps.get(20).getPilotCode(), 0);
		assertEquals("F.ALONSO", laps.get(20).getPilotName());
		...
		assertEquals(34.763, laps.get(20).getAverage(), 0);

		assertEquals(LocalTime.parse("23:53:39.660"), laps.get(21).getTime());
		assertEquals(11, laps.get(21).getPilotCode(), 0);
		assertEquals("S.VETTEL", laps.get(21).getPilotName());
		...
		assertEquals(28.435, laps.get(21).getAverage(), 0);

		assertEquals(LocalTime.parse("23:54:57.757"), laps.get(22).getTime());
		assertEquals(11, laps.get(22).getPilotCode(), 0);
		assertEquals("S.VETTEL", laps.get(22).getPilotName());
		...
		assertEquals(35.633, laps.get(22).getAverage(), 0);
	}

	@Test
	public void readFileChengeLinepositionsReal() {
		List<LapDto> laps = this.fileLogUnix.getLapsFromFile("/home/renandpf/Documentos/desenvolvimento/projetos/code/race-time-api/src/test/resources/race2.log");
		assertEquals(23, laps.size());
	}
}
